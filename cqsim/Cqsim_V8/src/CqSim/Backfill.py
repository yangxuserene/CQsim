...
class Backfill:
    ...
    def adapt_reset(self):
        ...
        while (i < len(self.ave_uti_interval)):
            item = float(self.ave_uti_interval[i])
            item_exist = 0
            j = 0
    ...
    def set_adapt_data (self):
        ...
        temp_uti_1 = self.info_module.sys_info[end_index]['ave_uti'][self.ave_uti_index[0]]
        temp_uti_2 = self.info_module.sys_info[end_index]['ave_uti'][self.ave_uti_index[1]]

...
def callback_ad_alg_para (option, opt_str, value, parser):
    ...
    return
def callback_ave_uti (option, opt_str, value, parser):
    temp_opt['ave_uti'].append(value)
    return
...
if __name__ == "__main__":
    ...
    temp_opt={'alg':[],'alg_sign':[],'bf_para':[],'win_para':[],'ad_win_para':[],'ad_bf_para':[],'ad_alg_para':[],'ave_uti':[]}
    ...
    # 40
    p.add_option("-u", "--uti", dest="ave_uti", type="string",\
        action="callback", callback=callback_ave_uti,\
        help="average utilization interval")
    ...
    inputPara['ave_uti']=opts.ave_uti
